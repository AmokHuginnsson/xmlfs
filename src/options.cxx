...
int handle_program_options( int argc_, char** argv_ ) {
	...
	HOptionInfo info( po );
	info.name( setup._programName ).intro( "XML based file system in user space" );
	bool help( false );
	bool conf( false );
	bool vers( false );
	po(
		...
		.recipient( setup._fsFilePath )
	)(
		HProgramOptionsHandler::HOption()
		.short_form( 'd' )
		.long_form( "debug" )
		.switch_type( HProgramOptionsHandler::HOption::ARGUMENT::NONE )
		.description( "put additional debugging information into the logs" )
